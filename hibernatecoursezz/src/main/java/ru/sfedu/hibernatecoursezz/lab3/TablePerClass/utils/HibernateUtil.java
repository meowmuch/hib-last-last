package ru.sfedu.hibernatecoursezz.lab3.TablePerClass.utils;
...
import ru.sfedu.hibernatecoursezz.lab3.TablePerClass.model.*;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            ...
            try{
                ...
                nf = new File(Constants.PATH_TO_CFG_XML_LAB3_TPC);
            };
            File file = nf;
