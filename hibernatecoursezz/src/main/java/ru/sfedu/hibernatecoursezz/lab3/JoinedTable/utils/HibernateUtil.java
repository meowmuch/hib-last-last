package ru.sfedu.hibernatecoursezz.lab3.JoinedTable.utils;
...
import ru.sfedu.hibernatecoursezz.lab3.JoinedTable.model.*;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            ...
            try{
                ...
                nf = new File(Constants.PATH_TO_CFG_XML_LAB_3_JT);
            };
            File file = nf;
