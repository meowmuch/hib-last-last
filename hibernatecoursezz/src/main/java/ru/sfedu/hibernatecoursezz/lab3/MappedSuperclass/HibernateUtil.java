package ru.sfedu.hibernatecoursezz.lab3.MappedSuperclass;
...
import ru.sfedu.hibernatecoursezz.lab3.MappedSuperclass.model.*;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            ...
            try{
                ...
                nf = new File(Constants.PATH_TO_CFG_XML_LAB3_MS);
            };
            File file = nf;
