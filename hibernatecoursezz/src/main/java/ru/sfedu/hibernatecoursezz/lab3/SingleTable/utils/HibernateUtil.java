package ru.sfedu.hibernatecoursezz.lab3.SingleTable.utils;
...
import ru.sfedu.hibernatecoursezz.lab3.SingleTable.model.*;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            ...
            try{
                ...
                nf = new File(Constants.PATH_TO_CFG_XML_LAB3_ST);
            };
            File file = nf;
